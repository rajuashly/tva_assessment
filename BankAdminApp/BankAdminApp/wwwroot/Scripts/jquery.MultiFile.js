			...
			.each(function () {
				...
				MultiFile.addToList = function (slave, slave_count, files) {
					...
					//$.each(files, function (i, file) {
						...
						var
							r = $('<div class="MultiFile-label" style="margin-top:5px;padding:1px;"></div>'),
							b = $('<a class="MultiFile-remove" href="#' + MultiFile.wrapID + '" style="background-color:#d21c1c; font-size:14px; color:#fff; padding:4px 9px;">' + MultiFile.STRING.remove + '</a>')
